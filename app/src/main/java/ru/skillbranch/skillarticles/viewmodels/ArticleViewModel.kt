    ...
    override fun handleBookmark() {
        ...
        val msg = if (currentState.isBookmark) Notify.TextMessage("Add to bookmarks")
            ...
            Notify.ActionMessage(
                ...
                toggleBookmark //bookmark handler in case "No, still like it" pressed
            )
        }
    ...
    override fun handleLike() {
        ...
        val msg = if (currentState.isLike) Notify.TextMessage("Mark is liked")
            ...
            Notify.ActionMessage(
                ...
                "No, still like it", //action label on snackbar
                toggleLike //like handler in case "No, still like it" pressed
            )
        }
...
data class ArticleState(
    ...
    val isLike: Boolean = false, // отмечено лайком
    ...
    val searchResults: List<Pair<Int, Int>> = emptyList(), // результат поиска (статровая и конечная позиция)
    val searchPosition: Int = 0, // текущая позиция найденного результата
    val shareLink: String? = null, // ссылка Share
    val title: String? = null, // заголовок статьи
    val category: String? = null, // категория
    val categoryIcon: Any? = null, // Icon категории
